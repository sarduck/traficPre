...
@app.route('/train')
def train():
    data = pd.read_csv('/home/sarthakm/VIT/SEM7/TARP/new/Traffic_Prediction/mp/static/Train.csv')
    ...
    data = pd.read_csv("/home/sarthakm/VIT/SEM7/TARP/new/Traffic_Prediction/mp/traffic_volume_data.csv")
...
def predict():
    ...
    s = ''
    if(y_pred <= 1000):
        volumepred= "No Traffic - expected volume=" + str(y_pred)
        print("No Traffic ")
        s = volumepred 
    elif y_pred > 1000 and y_pred <= 3000:
        volumepred= "Normal Traffic - expected volume=" + str(y_pred)
        print("Normal Traffic")
        s = volumepred 
    elif y_pred > 3000 and y_pred <= 5500:
        volumepred= "heavy Traffic - expected volume=" + str(y_pred)
        print("heavy Traffic")
        s = volumepred
    else:
        print("Worst case")
